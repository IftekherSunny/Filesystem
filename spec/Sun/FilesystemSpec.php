...
class FilesystemSpec extends ObjectBehavior
{
    ...
    public function it_throws_file_not_found_exception_if_the_file_does_not_exists_which_you_want_to_delete()
    {
    ...
    public function it_throws_file_not_found_exception_when_the_file_does_not_exists()
    {
        $this->shouldThrow('Sun\FileNotFoundException')->duringGet('foo.txt');
    }

    public function it_appends_more_content_to_existing_file()
    {
